package de.dzimmermann.rcp.bsgtaucha.mgt.factory;
 ...
 * which creates all local resources, needed to be created from within other
 * (calling) plugins
 * 
 * @author danielz
 */
public class LocalExecutableFactory implements ExecutableFactory {
	...
	public TitleAreaDialog createTitleAreaDialog(Task task, Shell parentShell)
		...
		if (task.getContextToLoadID() != null
				&& !task.getContextToLoadID().isEmpty()) {
