...
public class WorkEntryEditor extends EditorPart implements DirtyEditorSupport,
		ElementUpdateSupport<LocalFileModel>, PropertyChangeListener {

	public static final String ID = WorkEntryEditor.class.getName();

	public WorkEntryEditor() {
	}
	...
	private WorkEntryComposite composite;

	@Override
	public void createPartControl(Composite parent) {
		parent.setLayout(new FormLayout());

		composite = new WorkEntryComposite(parent, SWT.NONE, this,
	...
	@Override
	public void dispose() {
		((WorkEntryComposite) composite).removeListener(this);
		super.dispose();
	}
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (WorkEntryComposite.STATUSLINE_MESSAGE.equals(evt.getPropertyName())) {
			getEditorSite().getActionBars().getStatusLineManager()
					.setMessage((String) evt.getNewValue());
		} else if (WorkEntryComposite.ROOTMODEL_CHANGED_MESSAGE.equals(evt
				.getPropertyName())) {
