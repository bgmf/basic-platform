...
import de.dzimmermann.rcp.bsgtaucha.mgt.ui.component.BandComposite;
import de.dzimmermann.rcp.bsgtaucha.mgt.ui.component.WorkEntryComposite;
import de.dzimmermann.rcp.bsgtaucha.mgt.util.BSGTauchaUtils;

public class BandMgtEditor extends EditorPart implements DirtyEditorSupport,
		ElementUpdateSupport<LocalFileModel>, PropertyChangeListener {

	public static final String ID = BandMgtEditor.class.getName();

	public BandMgtEditor() {
	}
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		// marshaller.marshal(
		// new ObjectFactory().createRoot(model.getModel()), writer);
		//
		// writer.flush();
		//
		// Logger.logInfo(writer.getBuffer().toString());
		//
		// writer.close();
		// } catch (Exception e) {
		// Logger.logError(e);
	...
	private BandComposite composite;

	@Override
	public void createPartControl(Composite parent) {
		parent.setLayout(new FormLayout());

		composite = new BandComposite(parent, SWT.NONE, this,
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (BandComposite.ROOTMODEL_CHANGED_MESSAGE.equals(evt
				.getPropertyName())) {
