...
import de.dzimmermann.rcp.bsgtaucha.mgt.ui.component.WorkComposite;
import de.dzimmermann.rcp.bsgtaucha.mgt.util.BSGTauchaUtils;

public class TasksMgtEditor extends EditorPart implements DirtyEditorSupport,
		ElementUpdateSupport<LocalFileModel>, PropertyChangeListener {

	public static final String ID = TasksMgtEditor.class.getName();

	public TasksMgtEditor() {
	}
	...
	private WorkComposite composite;

	@Override
	public void createPartControl(Composite parent) {
		parent.setLayout(new FormLayout());

		composite = new WorkComposite(parent, SWT.NONE, this,
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (WorkComposite.ROOTMODEL_CHANGED_MESSAGE.equals(evt
				.getPropertyName())) {
